            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="single-cat text-center mb-50">
                        ...
                        <div class="cat-cap">
                            <h5><a href="#">QUALITY EQUIPMENT</a></h5>
                            <p>The sea freight service has grown consider ably in recent years. We spend timetting to
                                kn.</p>
                        </div>
                        <div class="img-cap">
                            <a href="" class="">Discover More About Us <i class="ti-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
